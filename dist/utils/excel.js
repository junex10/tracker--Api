...
const fs = require("fs");
const CreateExcel = (filename, sheet = 'Report', data, template = 'none', company_data, path = `excel/`) => {
    return new Promise((resolve) => {
        ...
        switch (template) {
            case 'medical':
                medicalTemplate(addSheet, rows, keys, book, company_data);
                break;
            default:
...
const medicalTemplate = (addSheet, rows, keys, workbook, company) => {
    ...
    const company_data = [
        '',
        `${company === null || company === void 0 ? void 0 : company.email}\n${company === null || company === void 0 ? void 0 : company.phone}\n${company === null || company === void 0 ? void 0 : company.address}`
    ];
