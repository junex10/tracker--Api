...
exports.SecretaryGuard = void 0;
const common_1 = require("@nestjs/common");
const utils_1 = require("../utils");
let SecretaryGuard = class SecretaryGuard {
    canActivate(context) {
        var _a, _b, _c, _d;
        ...
        if (auth !== '' && auth !== undefined) {
            ...
            if (main === undefined) {
                ...
                if ((main.LEVEL !== utils_1.Constants.LEVELS.SECRETARY) &&
...
SecretaryGuard = __decorate([
    (0, common_1.Injectable)()
], SecretaryGuard);
exports.SecretaryGuard = SecretaryGuard;
//# sourceMappingURL=secretary.guard.js.map