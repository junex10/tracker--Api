...
exports.BossGuard = void 0;
const common_1 = require("@nestjs/common");
const utils_1 = require("../utils");
let BossGuard = class BossGuard {
    canActivate(context) {
        var _a, _b, _c, _d;
        ...
        if (auth !== '' && auth !== undefined) {
            ...
            if (main === undefined) {
                ...
                if ((main.LEVEL !== utils_1.Constants.LEVELS.BOSS) &&
...
exports.BossGuard = BossGuard;
//# sourceMappingURL=boss.guard.js.map